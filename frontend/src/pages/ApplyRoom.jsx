...
const roomOptions = [
  { value: 'double', label: 'Double', price: 30000, description: '2 occupants, cozy and efficient' },
  { value: 'triple', label: 'Triple', price: 35000, description: '3 occupants, balanced price and space' },
  { value: 'quad', label: 'Quad', price: 40000, description: '4 occupants, more spacious and economical' },
]
      ...
      <Box sx={{ p: 4 }}>
        <Card sx={{ p: 3, border: '1px solid', borderColor: 'divider' }}>
          ...
          <Typography color="text.secondary" sx={{ mb: 3 }}>
            Your room request is already in process. You can return to the dashboard for updates.
          </Typography>
  ...
  return (
    <Box sx={{ p: 4 }}>
      ...
      <Typography sx={{ mb: 4, color: 'text.secondary' }}>
        Select the room type you want, then complete a secure payment to request assignment.
      </Typography>
      {error && (
      ...
      <RadioGroup value={selectedType} onChange={(event) => setSelectedType(event.target.value)}>
          ...
          {roomOptions.map((room) => (
            <Card
              ...
              sx={{
                ...
                borderColor: selectedType === room.value ? 'primary.main' : 'divider',
              }}
            >
              <FormControlLabel
                value={room.value}
      ...
      >
        {submitting ? 'Processing payment...' : `Request ${selectedRoomOption?.label} Room`}
      </Button>
    </Box>
  )
}
