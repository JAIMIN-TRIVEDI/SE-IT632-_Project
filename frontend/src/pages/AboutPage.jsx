...
const values = [
  {
    ...
    description:
      "From room requests to billing workflows, we reduce repetitive admin steps and deliver instant actions.",
  },
  {
    title: "Student-Centered Experience",
    icon: <GroupsRoundedIcon fontSize="small" />,
    description:
      "Everything is designed around clarity for students, wardens, and admins on every screen size.",
  },
  {
    title: "Secure by Design",
    icon: <SecurityRoundedIcon fontSize="small" />,
    description:
      "Role-based access, payment-ready modules, and transparent records to keep data protected and trusted.",
  },
  {
    title: "Data-Driven Growth",
    icon: <InsightsRoundedIcon fontSize="small" />,
    description:
      "Analytics surfaces occupancy, mess usage, and payment behavior so your next decision is evidence-based.",
  },
];
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Box
            sx={{
              ...
              right: { xs: -90, md: -130 },
              background:
                "radial-gradient(circle, rgba(16,185,129,0.42) 0%, rgba(16,185,129,0) 72%)",
              filter: "blur(8px)",
        ...
        >
          <Stack
            spacing={4}
            sx={{ maxWidth: 860, animation: "riseIn 0.9s ease forwards" }}
          >
            <Chip
              label={
                <Box
            ...
            >
              ...
              started with one mission: remove operational friction from hostel
              and mess management. We blend automation, transparency, and modern
              design so every stakeholder can move faster with confidence.
            </Typography>
            ...
            >
              <Box
                sx={{
                  ...
                  borderRadius: "50%",
                  background:
                    "radial-gradient(circle, rgba(14,165,233,0.28) 0%, rgba(14,165,233,0) 72%)",
              ...
              <Typography variant="h5" sx={{ fontWeight: 800, mb: 2.5 }}>
                ...
                >
                  Why Teams Choose{" "}
                  <BrandImage width={130} sx={{ display: "inline-block" }} />
                </Box>
              </Typography>
              <Stack spacing={2}>
